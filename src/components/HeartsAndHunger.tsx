          ...
          <div className="flex items-center gap-1">
            {hunger.map((state, i) => (
              ...
              >
                {state === 'full' && (
                  <Drumstick 
                    className="w-4 h-4 text-amber-600 fill-amber-500 drop-shadow-[0_0_3px_rgba(217,119,6,0.5)] rotate-45"
                    strokeWidth={2}
                  />
                )}
                {state === 'half' && (
                  <Drumstick 
                    className="w-4 h-4 text-amber-700 fill-amber-700/50 opacity-80 rotate-45"
                    strokeWidth={1.5}
                  />
                )}
                {state === 'empty' && (
                  <Drumstick 
                    className={`w-4 h-4 opacity-40 rotate-45 ${isDark ? 'text-zinc-600' : 'text-zinc-400'}`}
                    strokeWidth={1.5}
                  />
                )}
              </div>
