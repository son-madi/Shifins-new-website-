...
export default function App() {
  ...
  const dockTabConfig: Record<string, {
    ...
    hud_chat: {
      ...
      containerBorder: 'border-emerald-500/30 shadow-[0_0_20px_rgba(16,185,129,0.06)]',
    },
    anti_afk: {
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans selection:bg-zinc-700 selection:text-white transition-colors duration-200 ${
